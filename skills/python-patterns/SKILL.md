...
编写健壮、高效且可维护应用程序的 Python 惯用模式和最佳实践。
...
def load_config(path: str) -> Config:
    try:
        ...
        raise ConfigError(f"配置文件中的无效 JSON: {path}") from e
...
__记住__：Python 代码应该易读、显式，并遵循最小惊讶原则。当有疑问时，优先考虑清晰而不是耍聪明。
